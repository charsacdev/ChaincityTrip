...
<head>
  ...
  <title>ChainCity-Trip || Payment Successfull</title>
  ...
  <div class="page-wrapper">
    ...
    <div class="container-fluid accounts">
      <div class="row" style="position: relative; overflow: hidden;">
        ...
        <div class="col-12">
          <div class="rlf__logo">
            <img src="{{asset('asset/logo.png')}}" width="60px">
          </div>
        </div>
                ...
                <div class="col-12">
                  <div class="rlf_verify form-account">
                    ...
                    <p class="text-muted text-center">
                       Redirecting &nbsp; <i class="fa fa-spin fa-spinner"></i>
                    </p>
                  </div>
                </div>
              </div>
