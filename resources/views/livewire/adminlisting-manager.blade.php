             ...
             <div class="custom-tab mt-5" wire:ignore> 
                <div class="tab-container">
                  <ul class="nav nav-tabs" >
                       ...
                       <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#inprogress"> Inprogress</a>
                       </li>
                    </ul>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end drop-action">
                                                        <li><button class="dropdown-item" type="button" wire:click="Approvelisting({{$item->id}})">Approve</button></li>
                                                        <li><button class="dropdown-item" type="button" wire:click="DeclineListing({{$item->id}})">Decline</button></li>
                                                        <li><button class="dropdown-item" type="button" wire:click="DeleteListing({{$item->id}})">Delete</button></li>
                                                      </ul>  
                                                </td>
                                            </tr>
                                        @endforeach
