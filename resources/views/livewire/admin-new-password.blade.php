       ...
       <div class="row">
         <div class="col-12">
           <div class="form-account py-3">
             ...
             <form class="mt-5" id="admin_reset_pswd_form" wire:submit.prevent='DetailsUpdateAdmin'>
                  <!--error-->
                     @if(session('error'))
               ...
               <button type="submit" id="reset-btn-admin" class="rlf-btn rlf-btn-primary text-light w-100 my-3">Update</button>
             </form>
           </div>
         </div>
       </div>
