             ...
             <div class="row">
               <div class="col-12">
                 <div class="form-account">
                   ...
                   <h2 class="text-primary rlf-header">Forgot Your Password?</h2>
                   <h2 class="rlf-header">Don't worry we have a Spare Key</h2>
                   <p class="text-muted">
                    Have you remembered your password? <a href="login" class="text-primary">Login</a>
                   </p>
                   <form class="mt-5" id="auth_login_form" wire:submit.prevent='ResetPassword'>
                    <!--error-->
                        @if(session('error'))
                     ...
                     <div class="mb-4">
                       ...
                       <div class="input-group mb-3 i-group-div">
                         ...
                         <input type="email" name="email" wire:model="UserEmail" class="form-control shadow-none" placeholder="ex. example@gmail.com" required>
                       </div>
                     </div>
